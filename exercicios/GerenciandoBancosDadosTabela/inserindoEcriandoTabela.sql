...
-- CREATE DATABASE teste_dba;
 -- SHOW databases;
 -- USE teste_dba;
 -- CREATE TABLE produtos(nome VARCHAR(100),sku CHAR(5), informacoes MEDIUMTEXT,preco VARCHAR(100) );
--  CREATE TABLE cliente(nome VARCHAR(100) , sobrenome VARCHAR(100), email VARCHAR(150), idade INT(2), profissao VARCHAR(150), endereco MEDIUMTEXT);
/*INSERT INTO cliente(nome , sobrenome , email, idade , profissao , endereco )
